...
Route::get('/students/profile','ProfileController@show');
Route::PATCH('/student/profile','ProfileController@update');
Route::get('/students/apply','ProfileController@apply');
...
Route::get('/students/leave','ProfileController@getLeave');
Route::post('student/addLeave','ProfileController@addLeave')->name('student.leave');
...
Route::post('/admin/generate-seat-matrix','AdminController@generate_seat_matrix');
Route::get('/admin/studentApply','AdminController@showStudentApply');
...
Route::get('/admin/getUser/{userId}',function ($userId){
    ...
    $stu_edu = \App\StudentEducation::all();
    $stu_edu = $stu_edu->where('user_id',$userId);
    $data = array_merge([
        $data,
        $data_more
    ]);
